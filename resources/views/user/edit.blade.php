        ...
        <div class="panel-body">
            ...
            <form action="{{ url('user/update/'.$user->id) }}" role="form" id="form1" method="post" class="validate">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="name" value="{{ $user->name }}" data-validate="required" data-message-required="This is custom message for required field." placeholder="Required Field" />
                </div>
